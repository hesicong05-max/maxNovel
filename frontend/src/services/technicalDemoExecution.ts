...
export type PendingTechnicalDemoLoad = { status: "missing" } | { status: "available"; operation: PendingTechnicalDemoExecution } | { status: "foreign"; workspace: "planning" | "foreshadow" | "generation_execution" } | { status: "corrupt" } | { status: "unavailable" };

...
export type PendingTechnicalDemoLoad = { status: "missing" } | { status: "available"; operation: PendingTechnicalDemoExecution } | { status: "foreign"; workspace: "planning" | "foreshadow" | "generation_execution" | "candidate_manual_edit" } | { status: "corrupt" } | { status: "unavailable" };
